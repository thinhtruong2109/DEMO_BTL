...
function QuanLyTeacher() {
  ...
  function TeacherTable({ teachers }) {
    ...
    const handleDelete = async (ID) => {
      try {
        const response = await axios.delete(`https://school-system-nwgo.onrender.com/teacher/${ID}`);
  ...
  async function fetchData() {
    try {
      const response = await axios.get('https://school-system-nwgo.onrender.com/teacher/getAll');
  ...
  function CreateTeacherForm() {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await axios.post('https://school-system-nwgo.onrender.com/teacher/create', newTeacher);
        const { status, message } = response.data;
        if (status === 'success') {

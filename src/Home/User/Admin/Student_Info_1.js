...
// </Button>
  ...
  useEffect(() => {
    const fetchStudent = async () => {
      try {
        ...
        const response = await axios.get(`https://school-system-nwgo.onrender.com/student/studentId/${StudentUserID}`);
  ...
  useEffect(() => {
    const fetchStudentGPA = async () => {
      try {
        console.log(StudentUserID)
        const response = await axios.get(`https://school-system-nwgo.onrender.com/student/${StudentUserID}/credits-gpa`);
        const { data } = response.data;
        console.log(data)
  ...
  function EditStudentForm({ student, onUpdate }) {
    ...
    async function updateStudent(updatedStudent) {
      try {
        const response = await axios.put('https://school-system-nwgo.onrender.com/student', updatedStudent);

...
function QuanLyStudent() {
  ...
  function StudentTable({ students }) {
    ...
    const handleDelete = async (ID) => {
      try {
        const response = await axios.delete(`https://school-system-nwgo.onrender.com/student/studentId/${ID}`);
...
<>
  ...
  async function fetchData() {
    try {
      const response = await axios.get('https://school-system-nwgo.onrender.com/student/getAll');
  ...
  function CreateStudentForm({ student, onUpdate }) {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await axios.post('https://school-system-nwgo.onrender.com/student/create', newStudent);
        const { status, message } = response.data;
        if (status === 'success') {

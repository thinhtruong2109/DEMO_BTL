  ...
  ({
    ...
    function NhapDiemChoStudent()
    {
      ...
      const handleSubmitScores = async () => {
        ...
        try {
          const response = await axios.put(`https://school-system-nwgo.onrender.com/sheetmark/assignScores?studentId=${currentStudentId}&courseClassId=${IdMonHoc}&assignmentScore=${score1}&projectScore=${score2}&midTermScore=${score3}&finalExamScore=${score4}`);
